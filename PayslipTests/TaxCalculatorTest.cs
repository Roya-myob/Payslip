...
namespace PayslipTests
{
    public class TaxCalculatorTest
    {
        ...
        public void TaxCalculates_Generate_Correct_Tax_For_InRange_Salary(int salary, int lowerBound, int higherBound,
            decimal rate, int fixedAmount, decimal expectedResult)
        {
            TaxCalculator taxCalculator = new TaxCalculator();
            Assert.Equal(expectedResult, taxCalculator.CalculateTaxIncome(salary));
        }
        ...
        public void TaxCalculator_Generates_Correct_Amount_For_Boundary_Salary(int salary, int lowerBound,
